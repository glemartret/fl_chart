...
// in fl_chart/test/chart/gauge_chart/gauge_chart_renderer_test.dart.
...
/// A class which mocks [GaugeChartPainter].
///
/// See the documentation for Mockito's code generation for more information.
class MockGaugeChartPainter extends _i1.Mock implements _i10.GaugeChartPainter {
  MockGaugeChartPainter() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.Offset center(_i2.Size? size) => (super.noSuchMethod(
        Invocation.method(
          #center,
          [size],
        ),
